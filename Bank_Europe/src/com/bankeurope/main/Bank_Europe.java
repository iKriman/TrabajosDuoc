// Ignacio Kriman Bravo Sumaitva 1 Poo
/* sistema bancario con creacion de cuenta unica por cliente incluyendo 
   numero de cuenta y facilidades de deposito, giro y visualizacion 
   de informacion general */

package com.bankeurope.main;
import com.bankeurope.cliente.Cliente;
import com.bankeurope.cuentabancaria.tipos.CuentaAhorros;
import com.bankeurope.cuentabancaria.principal.CuentaBancaria;
import com.bankeurope.cuentabancaria.tipos.CuentaCorriente;
import com.bankeurope.cuentabancaria.tipos.CuentaDigital;
    ...
    public static void main(String[] args) {
        ...
        do { // ciclo do-while para realizar la cantidad de operaciones que el usario desee
            ...
            while (true) { // uso de trycatch para manejo de errores
                System.out.println("===Bienvenido a Europe Bank===");
                System.out.println(" ");
                System.out.println("1. Registrar Cliente.");
                System.out.println("2. Datos Cliente.");
                System.out.println("3. Depositar.");
                System.out.println("4. Girar.");
                System.out.println("5. Consultar Saldo e Intereses.");
            ...
            switch (opcionMenu) { 
                case 1: // REGISTRAR CLIENTE 
                    ...
                    int tipoCuenta = 0;
                    while (true) { /* Se aplicaron cargos por mantención a las cuentas corriente y digital.
                                      En el caso de la cuenta de ahorro, el interés se suma como ganancia. */
                        System.out.println(" ");
                    ...
                    switch (tipoCuenta) {
                        ...
                        case 2 -> cuentaCliente = new CuentaDigital (saldoIncial, nuevaCuenta);
                        case 3 -> cuentaCliente = new CuentaAhorros (saldoIncial, nuevaCuenta);
                ...
                case 2: // DATOS CLIENTE
                    if (cliente1 != null) {
                        cliente1.mostrarInformacionCliente(); // metodo de la instancia para consultar la info del cliente
                ...
                case 3: // DEPOSITAR
                    ...
                    cliente1.getCuenta().calcularInteres(); // en este metodo se utiliza el polimorfismo para obtener los interese dependiendo de la cuenta bancaria
                    } else {
                        System.out.println("Aun no hay ningun cliente registrado.");
                    }
                    System.out.println(" ");
                ...
                case 4: // GIRAR
                    ...
                    break;
                case 5: // CONSULTAR SALDO E INTERESES
                    if (cliente1 != null) {
