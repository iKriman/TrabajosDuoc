...
package com.bankeurope.cliente;
...
public class Cliente implements InfoCliente{
    ...
    private CuentaBancaria cuentaInterna; // cracion de una instancia de la clase Cuenta
    ...
    public Cliente(String rut, String nombre, String apellidoPaterno, String apellidoMaterno, String domicilio, String comuna,
            int telefono, CuentaBancaria cuentaInterna) {
